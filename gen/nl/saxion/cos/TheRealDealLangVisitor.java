...
public interface TheRealDealLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code functionDefinitionStamenet}
	 * labeled alternative in {@link TheRealDealLangParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionDefinitionStamenet(TheRealDealLangParser.FunctionDefinitionStamenetContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCallStatement(TheRealDealLangParser.FunctionCallStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCallExpr(TheRealDealLangParser.FunctionCallExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link TheRealDealLangParser#function_call}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunction_call(TheRealDealLangParser.Function_callContext ctx);
	/**
